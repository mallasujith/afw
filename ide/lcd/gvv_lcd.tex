...
\title{ 
	\logo{Interfacing LCD with pico W
	}
}
%\title{
...
%\title{Analog Design Through pico W}
%\author{G V V Sharma* }
...
%\begin{tabular}{ |p{3cm}|p{3cm}|}
 %\hline
 %\multicolumn{2}{|c|}{\textbf{pico W to LCD Connection}} \\
 %\hline
 %\textbf{pico W Pins} & \textbf{LCD Pins} \\
 %\hline
 %Pin D2 & Pin D7\\
 %\hline
 %Pin D3 & Pin D6\\
...
%
%\begin{problem}
%The resistance is an analogue function,but the value displayed on LCD is digital function.So,we need to do analogue to digital conversion,pico W has built-in 10-bit analogue to digital converter.
